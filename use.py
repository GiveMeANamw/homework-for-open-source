...
# image_PIL = Image.open('./test/dog/保存的地址1.jpg')
a=input("输入文件的相对路径")
# image_PIL = Image.open('./test/lion/保存的地址444.jpg')，这个正确率还挺高
# image_PIL = Image.open('./test/lion/保存的地址478.jpg')
image_PIL = Image.open(a)
